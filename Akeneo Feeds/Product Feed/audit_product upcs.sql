...
--looks for eagle products without a primary upc
drop table if exists #nflag
select *
into #nflag
from #union
where source = 'eagle' and (upc_primary_flag = 'n' or upc_primary_flag is null)

drop table if exists #yflag
select *
into #yflag
from #union
where source = 'eagle' and upc_primary_flag = 'y'

drop table if exists #noprimary
select distinct
n.sku,
n.source,
n.upc_sku,
